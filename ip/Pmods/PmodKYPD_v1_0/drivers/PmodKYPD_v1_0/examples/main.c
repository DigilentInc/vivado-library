...
//keytable is determined as follows (index in keytable shown in Keypad position below)
// 12 13 14 15
// 8  9  10 11
// 4  5  6  7
// 0  1  2  3
...
void DemoRun()
{
	...
	u8 key, last_key = 'x'; // initial value of last_key should not be contained in loaded KEYTABLE string
